const initialState = [
    {id: 0, contents: 'Card1', visible: true, matched: true}, 
    {id: 1, contents: 'Card1', visible: true, matched: true},
    {id: 2, contents: 'Card2', visible: true, matched: true},
    {id: 3, contents: 'Card2', visible: true, matched: true},
    {id: 4, contents: 'Card3', visible: true, matched: true},
    {id: 5, contents: 'Card3', visible: true, matched: true},
    {id: 6, contents: 'Card4', visible: true, matched: true},
    {id: 7, contents: 'Card4', visible: true, matched: true},
    {id: 8, contents: 'Card5', visible: true, matched: true},
    {id: 9, contents: 'Card5', visible: true, matched: true},
    {id: 10, contents: 'Card6', visible: true, matched: true},
    {id: 11, contents: 'Card6', visible: true, matched: true},
    {id: 12, contents: 'Card7', visible: true, matched: true},
    {id: 13, contents: 'Card7', visible: true, matched: true},
    {id: 14, contents: 'Card8', visible: true, matched: true},
    {id: 15, contents: 'Card8', visible: true, matched: true},
  ];
